...
export default ts.config(
	...
	{ ignores: ['dist/**', 'node_modules/**', 'bin/**', 'build/**'] },
	{
		...
		languageOptions: { parserOptions: { ecmaVersion: 'latest', sourceType: 'module', project: true, tsconfigRootDir: process.cwd() } },
		...
		rules: {
			...
			'@typescript-eslint/naming-convention': ['error', { selector: 'objectLiteralProperty', format: ['camelCase', 'snake_case', 'UPPER_CASE'] }], // enforce variable naming style
